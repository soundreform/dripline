...
static constexpr Pin PIN_JACK_SWITCH_LEFT_IN = daisy::seed::D5;
static constexpr Pin PIN_JACK_SWITCH_LEFT_OUT = daisy::seed::D6;
...
static constexpr Pin PIN_JACK_SWITCH_RIGHT_IN = daisy::seed::D27;
static constexpr Pin PIN_JACK_SWITCH_RIGHT_OUT = daisy::seed::D28;
...
static constexpr size_t knob_addrs[Dripline::KNOB_LAST][2] = {
    {ADDR_KNOB_MUX_2, ADDR_KNOB_1}, {ADDR_KNOB_MUX_2, ADDR_KNOB_2},  {ADDR_KNOB_MUX_2, ADDR_KNOB_3},  {ADDR_KNOB_MUX_1, ADDR_KNOB_4},
    {ADDR_KNOB_MUX_1, ADDR_KNOB_5}, {ADDR_KNOB_MUX_1, ADDR_KNOB_6},  {ADDR_KNOB_MUX_2, ADDR_KNOB_7},  {ADDR_KNOB_MUX_2, ADDR_KNOB_8},
    {ADDR_KNOB_MUX_2, ADDR_KNOB_9}, {ADDR_KNOB_MUX_1, ADDR_KNOB_10}, {ADDR_KNOB_MUX_1, ADDR_KNOB_11}, {ADDR_KNOB_MUX_1, ADDR_KNOB_12},
};
...
static constexpr size_t toggle_addrs[Dripline::TOGGLE_SWITCH_LAST][2] = {
    {ADDR_TOGGLE_1_UP, ADDR_TOGGLE_1_DOWN}, {ADDR_TOGGLE_2_UP, ADDR_TOGGLE_2_DOWN}, {ADDR_TOGGLE_3_UP, ADDR_TOGGLE_3_DOWN},
    {ADDR_TOGGLE_4_UP, ADDR_TOGGLE_4_DOWN}, {ADDR_TOGGLE_5_UP, ADDR_TOGGLE_5_DOWN}, {ADDR_TOGGLE_6_UP, ADDR_TOGGLE_6_DOWN},
};
